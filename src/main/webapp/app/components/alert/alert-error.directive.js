(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('ramhacks2016App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-ramhacks2016App-error');
                var entityKey = httpResponse.headers('X-ramhacks2016App-params');
                if (errorHeader) {
